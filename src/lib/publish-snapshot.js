...
async function publishSnapshot({
    ...
    {
        warning(`A snapshot is published only when its validation status is 'passed' or 'passed_with_exception'. The snapshot '${snapshotRec.name}' cannot be published as its validation status is ${validationStatus}.`);
        return false;
    }
